...
export default class Question {
    ...
    registerPublicMethods() {
        ...
        facade.enable = () => {
            // IT LOOKS LIKE THIS IS BEING CALLED IN REVIEW, when it should not be.
        ...
        choices.forEach((choice) => {
            choice.addEventListener("click", (event) => {
               ...
               facade.resetValidationUI()
                ...
                let responseObject = { 
                    // store the value of the student's response
                    value: event.target.value, 
                    // Whenever the student enters a response, store the custom_type of the custom question in the response data
                    // so that that this data will be surfaced alongside the response data in sessions / responses.
                    custom_type: this.init.question.custom_type
                };
                /**
                ...
                console.log("You clicked a choice! The current response data is now: ", facade.getResponse());
             ...
             
                {
                    "value": {
                        "value": "0",
                        "custom_type" "<THIS custom questions custom_type value>" <---------
                    },
                    "type": "object",
