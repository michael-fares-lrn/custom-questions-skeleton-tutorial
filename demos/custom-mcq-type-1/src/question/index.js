    ...
    registerPublicMethods() {
        ...
        //    this.disabled = true;
            ...
            el.querySelectorAll('input').forEach(input => { 
                console.log("the input that should be disabled is", input)    
                input.disabled = true 
            });
    ...
    handleEvents() {
        ...
        choices.forEach((choice) => {
            choice.addEventListener("click", (event) => {
                console.log("init.state inside of click event is", init.state) 
                if (init.state === "review") {
                    console.log("state is review, should return")
                    return
                }
        ...
        events.on('validate', options => {
            console.log("init.state is", init.state)
            if (init.state === 'review') {
                console.log("the state is REVIEW!!!!!!!!!!!")
                console.log('init.getFacade() IS', init.getFacade())
